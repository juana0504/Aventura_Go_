...
<body>
  ...
  <div class="contenedor">
    <form action="generar-clave" class="formulario" method="POST">
      ...
      <input type="email" name="email" placeholder="Correo" class="entrada" />

      <p class="instruccion">Asunto</p>
      <input type="text" name="asunto" placeholder="asunto" class="entrada" />

      <p class="instruccion">Mensaje</p>
      <input type="text" name="mensaje" placeholder="mensaje" class="entrada" />

      <p class="nota">Te enviaremos un código de verificación a este correo.</p>
