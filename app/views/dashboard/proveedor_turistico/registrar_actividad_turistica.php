...
<head>
    ...
    <title>Registrar Actividad — AventuraGO</title>
...
<div class="pv-layout" id="registrar-actividades">
    ...
    <nav class="pv-sidebar">
        ...
        <a href="<?= BASE_URL ?>proveedor/registrar-actividad" class="pv-nav-item pv-nav-item--active">
    ...
    <div class="pv-main">
        ...
        <main class="pv-content">
            ...
            <div style="margin-bottom:24px;">
                ...
                <h1 class="pv-page-title">Nueva <span>Actividad</span></h1>
                <p class="pv-greeting__sub">Registra una nueva experiencia turística para tus clientes</p>
            </div>
            ...
            <div class="pv-ra-layout">
                        ...
                        <div class="pv-wizard">
                            ...
                            <div class="wizard-content pv-wizard__content">
                                ...
                                <div class="wizard-step active" id="step-1">
                                    ...
                                    <input type="text" name="nombre" class="pv-form-input" placeholder="Ej: Rafting en el Río Negro" required>
                                    ...
                                    <input type="text" name="ubicacion" class="pv-form-input" placeholder="Ej: Km 12 vía Villeta - Bogotá" required>
                                ...
                                <div class="wizard-step" id="step-2">
                                    ...
                                    <textarea name="descripcion" class="pv-form-input pv-form-textarea" rows="4"
                                        placeholder="Describe la experiencia que vivirán los participantes..." required></textarea>

                                    <label class="pv-form-label mt-3">Cupos disponibles</label>
                                    <input type="number" name="cupos" class="pv-form-input" min="1" placeholder="Ej: 20" required>
                                ...
                                <div class="wizard-step" id="step-3">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" name="precio" class="pv-form-input" min="0" placeholder="Ej: 80000" required>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <label class="pv-form-label mt-3">Imágenes de la actividad <small class="pv-form-hint">(máx. 5, JPG/PNG, 2 MB c/u)</small></label>
                                    <input type="file" name="imagenes[]" class="pv-form-input pv-form-input--file" multiple accept=".jpg,.jpeg,.png" required>

                                    <div class="pv-wizard__actions">
                                        <button type="button" class="pv-wizard__btn-prev" onclick="prevStep(2)">
                                            <i class="fas fa-arrow-left"></i> Anterior
                                        </button>
                                        <button type="button" class="pv-wizard__btn-next" onclick="nextStep(4)">
                                            Siguiente <i class="fas fa-arrow-right"></i>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="wizard-step" id="step-4">
                                    <div class="pv-wizard__step-title">
                                        <div class="pv-wizard__step-icon" style="background:rgba(16,185,129,.12);"><i class="fas fa-check-circle" style="color:#10b981;"></i></div>
                                        <h4>Confirmar actividad</h4>
                                    </div>

                                    <div class="pv-preview-grid">
                                        <div class="pv-preview-card">
                                            <div class="pv-preview-card__header"><i class="fas fa-map-marked-alt"></i> Información</div>
                                            <div class="pv-preview-card__body">
                                                ...
                                                <div class="pv-preview-field"><span class="pv-preview-label">Departamento</span><span class="preview-value" id="prev-departamento">—</span></div>
                                                <div class="pv-preview-field"><span class="pv-preview-label">Ciudad</span><span class="preview-value" id="prev-ciudad">—</span></div>
                                                <div class="pv-preview-field"><span class="pv-preview-label">Ubicación</span><span class="preview-value" id="prev-ubicacion">—</span></div>
                                            </div>
                                        </div>
                                        <div class="pv-preview-card">
                                            <div class="pv-preview-card__header"><i class="fas fa-info-circle"></i> Detalles</div>
                                            <div class="pv-preview-card__body">
                                                <div class="pv-preview-field"><span class="pv-preview-label">Cupos</span><span class="preview-value" id="prev-cupos">—</span></div>
                                                <div class="pv-preview-field"><span class="pv-preview-label">Precio</span><span class="preview-value" id="prev-precio">—</span></div>
                                                <div class="pv-preview-field pv-preview-field--full"><span class="pv-preview-label">Descripción</span><span class="preview-value" id="prev-descripcion">—</span></div>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="pv-wizard__actions">
                                        <button type="button" class="pv-wizard__btn-prev" onclick="prevStep(3)">
                                            <i class="fas fa-arrow-left"></i> Anterior
                                        </button>
                ...
                <aside class="pv-ci-info-panel">
                    ...
                    <div class="pv-ci-info-item">
                        <div class="pv-ci-info-item__icon"><i class="bi bi-eye"></i></div>
                        <div>
                            <div class="pv-ci-info-item__title">Más visibilidad</div>
                            <p class="pv-ci-info-item__text">Tu actividad aparecerá en la plataforma para que turistas interesados en aventura puedan encontrarla.</p>
                        </div>
                    </div>
                    ...
                    <div class="pv-ci-info-item">
                        ...
                        <div>
                            <div class="pv-ci-info-item__title">Fotos atractivas</div>
                            <p class="pv-ci-info-item__text">Sube hasta 5 imágenes de calidad. La primera imagen será la principal en el catálogo.</p>
                        </div>
                    </div>

                    <div class="pv-ci-info-item">
                        <div class="pv-ci-info-item__icon"><i class="bi bi-people"></i></div>
                        <div>
                            <div class="pv-ci-info-item__title">Gestiona cupos</div>
                            <p class="pv-ci-info-item__text">Controla la disponibilidad configurando el número máximo de participantes.</p>
                        </div>
                    </div>

                    <div class="pv-ci-info-item">
                        <div class="pv-ci-info-item__icon"><i class="bi bi-cash-stack"></i></div>
                        <div>
                            <div class="pv-ci-info-item__title">Define tu precio</div>
                            <p class="pv-ci-info-item__text">Establece el precio por persona y actualízalo cuando lo necesites desde tus actividades.</p>
                        </div>
                    </div>
...
function cargarResumen() {
    ...
    document.getElementById('prev-precio').textContent =
        '$' + (parseInt(document.querySelector('input[name="precio"]').value || 0)).toLocaleString('es-CO');
    document.getElementById('prev-descripcion').textContent =
        document.querySelector('textarea[name="descripcion"]').value || '—';
    document.getElementById('prev-departamento').textContent =
        document.querySelector('#id_departamento option:checked')?.textContent || '—';
    document.getElementById('prev-ciudad').textContent =
