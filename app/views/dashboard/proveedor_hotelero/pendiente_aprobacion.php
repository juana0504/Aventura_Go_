...
require_once BASE_PATH . '/app/models/proveedor_hotelero/ProveedorModel.php';
        ...
        <main class="pv-content" style="display:flex; align-items:center; justify-content:center;">
            ...
            <div style="max-width:560px; width:100%; text-align:center; padding: 40px 24px;">
                ...
                <p style="color:var(--pv-muted);font-size:15px;line-height:1.6;margin-bottom:32px;">
                    ...
                    Una vez aprobado, podrás registrar hospedajes y comenzar a recibir reservas.
                </p>
                ...
                <div style="background:var(--pv-surface);border:1px solid var(--pv-border);border-radius:var(--pv-radius-lg);padding:24px;margin-bottom:28px;text-align:left;">
                    ...
                    <div style="display:flex;flex-direction:column;gap:12px;">
                        ...
                        <div style="display:flex;align-items:center;gap:12px;">
                            <div style="width:28px;height:28px;border-radius:50%;background:<?= (!empty($proveedorInfo) && !empty($proveedorInfo['nombre_establecimiento'])) ? '#10b981' : '#f59e0b' ?>;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                                <i class="bi bi-<?= (!empty($proveedorInfo) && !empty($proveedorInfo['nombre_establecimiento'])) ? 'check-lg' : 'pencil' ?>" style="color:#fff;font-size:13px;"></i>
                            </div>
                            <span style="font-size:14px;color:var(--pv-text);">
                                Información del establecimiento completada
                                <?php if (empty($proveedorInfo['nombre_establecimiento'])): ?>
                                    — <a href="<?= BASE_URL ?>proveedor_hotelero/completar-informacion" style="color:var(--pv-primary);font-weight:600;">Completar ahora</a>
                                <?php endif; ?>
                            </span>
                        </div>
                        <div style="display:flex;align-items:center;gap:12px;">
                        ...
                        <div style="display:flex;align-items:center;gap:12px;">
                            ...
                            <span style="font-size:14px;color:var(--pv-muted);">Cuenta activa — publica hospedajes</span>
                        </div>
                    </div>
                </div>
                ...
                <div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap;">
                    <a href="<?= BASE_URL ?>proveedor_hotelero/completar-informacion"
                    ...
                    <a href="<?= BASE_URL ?>proveedor_hotelero/tickets"
