   ...
   public function listarPorturista($id_turista, $filtro = '') {
    ...
    public function listarPorId($id_reserva) {
        $sql = "SELECT 
                ...
                JOIN turista p ON a.id_turista = p.id_turista
    ...
    /**
     * Verificar si una reserva pertenece al turista actual (seguridad)
     */
    public function verificarReservaDeturista($id_reserva, $id_turista) {
        $sql = "SELECT COUNT(*) as count 
                ...
                JOIN reserva_actividad ra ON r.id_reserva = ra.id_reserva
                JOIN actividad a ON ra.id_actividad = a.id_actividad
                WHERE r.id_reserva = :id_reserva AND a.id_turista = :id_turista";
    ...
    /**
     * Obtener estadísticas de reservas para el turista
     */
