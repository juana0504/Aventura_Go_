...
require_once __DIR__ . '/../../models/proveedor_hotelero/editarPerfilProveedorHotelero.php';
...
switch ($method) {
    ...
    case 'POST':
        actualizarPerfilProveedorHotelero();
        break;

    case 'GET':
        mostrarPerfilProveedorHotelero();
        break;
...
// ------------------------------------------------------------
// MOSTRAR PERFIL DEL PROVEEDOR HOTELERO
// ------------------------------------------------------------

function mostrarPerfilProveedorHotelero()
{
...
// ------------------------------------------------------------
// ACTUALIZAR PERFIL DEL PROVEEDOR HOTELERO
// ------------------------------------------------------------

function actualizarPerfilProveedorHotelero()
{
    if (!isset($_SESSION['user'])) {
        mostrarSweetAlert('error', 'Sesión no iniciada', 'Debes iniciar sesión.');
        exit();
    ...
    // --------------------------------------------------------
    $obj = new EditarPerfilProveedorHotelero();
